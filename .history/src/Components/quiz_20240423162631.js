...
function App() {
  ...
  // Render loading message only when questions array is empty or undefined
  if (!questions || questions.length === 0) {
    return <div className="loading">Loading...</div>;
  }

  // Handle case where currentQuestionIndex exceeds the length of the questions array
